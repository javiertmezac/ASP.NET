<%@ Page Title="Grado" MasterPageFile="~/MPManagement.Master" Language="C#" AutoEventWireup="true" CodeFile="Grado.aspx.cs" Inherits="Account_Grado" %>
            ...
            <asp:MultiView ID="mvCatalogo" runat="server" ActiveViewIndex="0">
                    ...
                    <asp:Table ID="Table1" runat="server" Style="width: 90%">
                        <asp:TableRow>
                            <asp:TableCell Style="width: 110px; vertical-align: top; text-align: left">
                                <asp:Label ID="lblProfesor" runat="server" Text="Profesor:" CssClass="lbl"></asp:Label>                           
                                <asp:DropDownList ID="cboProfesor" runat="server" CssClass="cbo" Width="150px" AutoPostBack="true" OnSelectedIndexChanged="cboProfesor_SelectedIndexChanged"></asp:DropDownList>
                            </asp:TableCell>
                        </asp:TableRow>
                        <asp:TableRow>
                            <asp:TableCell>
                ...
                <asp:View ID="vAgregar" runat="server">
                    ...
                    <asp:Table ID="Table2" Style="width: 515px" runat="server">
                        ...
                        <asp:TableRow>
                            <asp:TableCell Style="width: 110px; vertical-align: top; text-align: left">
                                <asp:Label ID="lblGrado" runat="server" Text="Grado:" CssClass="lbl"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:TextBox ID="txtGrado" runat="server" Width="150px" CssClass="txt" />
                                <asp:RequiredFieldValidator ID="rfvGrado" runat="server" ErrorMessage="*" ValidationGroup="1" ControlToValidate="txtGrado">*</asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>

                        <asp:TableRow>
                            <asp:TableCell Style="width: 110px; vertical-align: top; text-align: left">
                                <asp:Label ID="lblTipoGrado" runat="server" Text="Tipo:" CssClass="lbl"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:DropDownList ID="cboTipoGrado" runat="server" CssClass="cbo" Width="150px"></asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvTipoGrado" runat="server" ErrorMessage="*" ControlToValidate="cboTipoGrado" InitialValue="0" ValidationGroup="1">*</asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>

                        <asp:TableRow>
                            <asp:TableCell Style="width: 110px; vertical-align: top; text-align: left">
                                <asp:Label ID="lblCedula" runat="server" Text="Cédula:" CssClass="lbl"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:TextBox ID="txtCedula" runat="server" Width="150px" CssClass="txt" />
                                <asp:RequiredFieldValidator ID="rfvCedula" runat="server" ErrorMessage="*" ValidationGroup="1" ControlToValidate="txtCedula">*</asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>

                        <asp:TableRow>
                            <asp:TableCell Style="width: 110px; vertical-align: top; text-align: left">
                                <asp:Label ID="lblInstitucion" runat="server" Text="Institución:" CssClass="lbl"></asp:Label>
                            </asp:TableCell>
                            <asp:TableCell>
                                <asp:TextBox ID="txtInstitucion" runat="server" Width="150px" CssClass="txt" />
                                <asp:RequiredFieldValidator ID="rfvInstitucion" runat="server" ErrorMessage="*" ValidationGroup="1" ControlToValidate="txtInstitucion">*</asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>
                        ...
                        <asp:TableRow>
                            ...
                            <asp:TableCell>
                                <asp:TextBox ID="txtFecha" runat="server" Width="150px" ReadOnly="true" CssClass="txt"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ValidationGroup="1" ControlToValidate="txtFecha">*</asp:RequiredFieldValidator>
                            </asp:TableCell>
                        </asp:TableRow>
                    ...
                    <asp:Panel ID="pnlFecha" runat="server" CssClass="popupControl">
                        <asp:UpdatePanel ID="upCalendario" runat="server">
                            <ContentTemplate>
                                <asp:Calendar ID="calFecha" runat="server" CssClass="cal" OnSelectionChanged="calFecha_SelectionChanged">
                        ...
                        <ajax:PopupControlExtender ID="PopupControlExtender1" runat="server" TargetControlID="txtFecha"
